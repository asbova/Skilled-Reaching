function h_fig = plotIndTotalReach(exptSummary)
...
%
for k = 1:22
    for i = 1:size(exptSummary.num_trials,2)
        data(k,i) = exptSummary.num_trials(k,i) - exptSummary.num_trials(2,i);
    end
end 
