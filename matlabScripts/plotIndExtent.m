function h_fig = plotIndExtent(exptSummary)
...
for k = 1:22
    for i = 1:size(exptSummary.mean_dig2_endPt,1)
        data(k,i) = exptSummary.mean_dig2_endPt(i,k,3) - exptSummary.mean_dig2_endPt(i,2,3);
    end
end 
...
% figure properties
b(1).FaceColor = figColor;

set(gca,'xticklabels',{'laser 1', 'laser 5', 'laser 10', 'occluded 1', 'occluded 10'});
ylabel('change in reach extent (mm)')
set(gca,'ylim',[minValue maxValue],'ytick',[-10 0 10 20]);
set(gca,'FontSize',10);
xtickangle(45)
box off