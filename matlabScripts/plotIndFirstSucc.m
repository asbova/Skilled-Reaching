function h_fig = plotIndFirstSucc(exptSummary)
...
%
for k = 1:22
    for i = 1:size(exptSummary.firstReachSuccess,2)
        data(k,i) = exptSummary.firstReachSuccess(k,i) - exptSummary.firstReachSuccess(2,i);
    end
end 
...
ylabel('change in first reach success')
